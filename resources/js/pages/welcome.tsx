                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        ...
                        <div className="relative -mb-px aspect-[335/376] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1D0002]">
                            <svg
                                className="w-full max-w-none translate-y-0 text-[#F53003] opacity-100 transition-all duration-750 dark:text-[#F61500]"
                                viewBox="0 0 438 104"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                            ...
                            <svg
                                ...
                                xmlns="http://www.w3.org/2000/svg"
                            >
                                <g className="translate-y-0 opacity-100 transition-all delay-300 duration-750 ">
                                    <path
                                ...
                                <g
                                    ...
                                    className="translate-y-0 opacity-100 transition-all delay-300 duration-750 "
                                >
                                    <path
                                ...
                                <g className="translate-y-0 opacity-100 mix-blend-plus-darker transition-all delay-300 duration-750 ">
                                    <path
